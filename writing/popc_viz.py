...
parser.add_argument('--lipids', type=int, default=1, help='Number of lipids')
parser.add_argument('--density', type=float, default=3, help='Number density of beads')
...
out_file = os.path.join(script_dir, "popc_viz.data")
